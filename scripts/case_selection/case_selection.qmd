...
3. Sample was sequenced between allowed date range
    * Minimum sequencing date: `{python} config['phase'][phase]['cohort'][cohort]['date']['seq_min'] if config['phase'][phase]['cohort'][cohort]['site'][site].get('date') is None else config['phase'][phase]['cohort'][cohort]['site'][site]['date']['seq_min']`
    * Maximum sequencing date: `{python} config['phase'][phase]['cohort'][cohort]['date']['seq_max'] if config['phase'][phase]['cohort'][cohort]['site'][site].get('date') is None else config['phase'][phase]['cohort'][cohort]['site'][site]['date']['seq_max']`
