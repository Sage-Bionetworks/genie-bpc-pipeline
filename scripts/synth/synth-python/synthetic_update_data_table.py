...
def update_redact_table(syn, cohort_info, redacted_table_info, full_data_table_info, logger):
    interval_cols_info = download_synapse_table(syn,cohort_info["synid_table_phicol"],'')
...
def main():
    ...
    # get master table
    table_id, condition = [cohort_info[table_type+"_table"]["synid_table_view"], cohort_info[table_type+"_table"]["condition"]]
